...
# Fast-loading Shortcutter zsh integration
# This file should be sourced in your .zshrc for better performance
...
shortcutter_widget() {
    ...
    # Run shortcutter with normal mode (not fast mode) when actually invoked
    local result=$(SHORTCUTTER_FAST_MODE=0 timeout 10s shortcutter 2>/dev/null)
